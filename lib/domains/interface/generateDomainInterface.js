...
import { generateFieldGetterSignature } from "../accessors/generateFieldGetterForDomain.js";
import { generateFieldSetterSignature } from "../accessors/generateFieldSetterForDomain.js";
...
function getMembersBasedOnIdField() {
	...
	return [
		...idFieldSpecs.map(fieldSpec => generateFieldGetterSignature(sObjectApiName, fieldSpec.apiName)),
		...idFieldSpecs.map(fieldSpec => generateFieldSetterSignature(sObjectApiName, fieldSpec.apiName))
	]
}
