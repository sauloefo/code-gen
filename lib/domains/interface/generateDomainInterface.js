...
import { generateGetterSignature } from "../accessors/generateFieldGetterForDomain.js";
import { generateSetterSignature } from "../accessors/generateFieldSetterForDomain.js";
...
function getMembersBasedOnIdField() {
	...
	return [
		...idFieldSpecs.map(fieldSpec => generateGetterSignature(sObjectApiName, fieldSpec.apiName)),
		...idFieldSpecs.map(fieldSpec => generateSetterSignature(sObjectApiName, fieldSpec.apiName))
	]
}
