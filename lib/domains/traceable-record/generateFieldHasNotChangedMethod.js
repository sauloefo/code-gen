export { 
	generateFieldHasNotChangedMethod,
	generateFieldHasNotChangedMethodHeader,
	getNameOfFieldHasNotChangedMethod
}

function generateFieldHasNotChangedMethod(sObjectApiName, fieldApiName) {
	...
	return {
		name,
		type: cgs.fragmentTypes.fieldHasNotChangedForTraceableRecordMethod,
		sourceCode
	}
}

function generateFieldHasNotChangedMethodHeader(sObjectApiName, fieldApiName) {
	setInternals(sObjectApiName, fieldApiName);
	...
	return {
		name,
		type: cgs.fragmentTypes.fieldHasNotChangedForTraceableRecordMethodHeader,
		sourceCode
	}
}

function getNameOfFieldHasNotChangedMethod(sObjectApiName, fieldApiName) {
	setInternals(sObjectApiName, fieldApiName);
...
function getMethodName() {
	...
	return `${singularName}HasNotChanged`;
}
...
function getSourceCode() {
	...
	const statements = [
		`public ${methodHeader} {`,
		`  return fieldValueHasNotChanged(${fieldSchemaName});`,
		"}"
	];
