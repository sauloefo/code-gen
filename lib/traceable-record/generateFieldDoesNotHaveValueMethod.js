export { 
	generateFieldDoesNotHaveValueMethod,
	generateFieldDoesNotHaveValueMethodHeader,
	getMethodNameOfFieldDoesNotHaveValueMethod
}

function generateFieldDoesNotHaveValueMethod(sObjectApiName, fieldApiName) {
	...
	return {
		name,
		type: cgs.fragmentTypes.fieldHasNotValueForTraceableRecordMethod,
		sourceCode
	}
}

function generateFieldDoesNotHaveValueMethodHeader(sObjectApiName, fieldApiName) {
	setInternals(sObjectApiName, fieldApiName);
	...
	return {
		name,
		type: cgs.fragmentTypes.fieldHasNotValueForTraceableRecordMethodHeader,
		sourceCode
	}
}

function getMethodNameOfFieldDoesNotHaveValueMethod(sObjectApiName, fieldApiName) {
	setInternals(sObjectApiName, fieldApiName);
...
function getMethodName() {
	...
	return `doesNotHave${singularName}`;
}
...
function getSourceCode() {
	...
	const statements = [
		`public ${methodHeader} {`,
		`  return doesNotHaveValue(${fieldSchemaName});`,
		"}"
	];
