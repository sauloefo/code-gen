...
function createDomainGetterMethodSourceCodeSpec(sourceCode,relatedFieldApiName) {
	return {
		sourceCode,
		sourceCodeType: sourceCodeTypes.domainGetterMethod,
		relatedFieldApiName
	}
}

function createDomainGetterMethodSignatureSourceCodeSpec(sourceCode,relatedFieldApiName) {
	return {
		sourceCode,
		sourceCodeType: sourceCodeTypes.domainGetterMethodSignature,
		relatedFieldApiName
	}
}
...
function generateDomainInterface (sourceCode, interfaceName) {
	return {
		sourceCode,
		sourceCodeType: sourceCodeTypes.domainInterface,
		name: interfaceName
	}
}

function createDomainSetterMethodSourceCodeSpec(sourceCode,relatedFieldApiName) {
	return {
		sourceCode,
		sourceCodeType: sourceCodeTypes.domainSetterMethod,
		relatedFieldApiName
	}
}

function createDomainSetterMethodSignatureSourceCodeSpec(sourceCode,relatedFieldApiName) {
	return {
		sourceCode,
		sourceCodeType: sourceCodeTypes.domainSetterMethodSignature,
		relatedFieldApiName
	}
}
...
export default {
	createDomainGetterMethodSourceCodeSpec,
	createDomainGetterMethodSignatureSourceCodeSpec,
	generateDomainInterface,
	createDomainSetterMethodSourceCodeSpec,
	createDomainSetterMethodSignatureSourceCodeSpec,
